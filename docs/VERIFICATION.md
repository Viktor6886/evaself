...
2. отправьте сообщение через Telegram E2E workflow;
...
9. выполните backup и restore на тестовом VPS;
10. проверьте, что WebUI нигде не показывает API Key или App Server token.
