 ...
 * вебхуком Lava, и строка, назначенная администратором, живут в одной
 ...
 * ещё не истёк.
 *
 * Lava не ломается: `payments.ts` продолжает вставлять свои строки той же
 * формой запроса. Колонка `source` имеет значение по умолчанию `payment`,
 * то есть вебхук, ничего не знающий про этот сервис, создаёт ровно то,
 * что и раньше.
 *
