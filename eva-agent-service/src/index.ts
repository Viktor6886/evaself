...
async function main(): Promise<void> {
  ...
  const skillIndexer = artifactRegistry ? new FilesystemSkillIndexer(artifactRegistry, { root: ".skills", runtimeRoot: "/data/letta/.skills", environment: "production" }) : null;
  syncSkills = skillIndexer ? async () => logger.info("Project skills synchronized", await skillIndexer.sync()) : async () => {};
