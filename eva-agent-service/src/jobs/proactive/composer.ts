  ...
  if (kind === "initiative") {
    ...
    return [
      ...
      "Пиши как человек, который вспомнил и написал, а не как сервис,"
        ...
        + " без «как дела?» ради заполнения, без отчёта о том, что ты"
        + " делала. Не начинай с извинений за беспокойство.",
      "Если повода нет — молчание лучше вежливой пустоты."
        + ` Ответь ровно ${SKIP_MARKER}.`,
