 ...
 *
 * Telegram Stars подтверждает деньги отдельно от изменения права доступа.
 * Этот модуль держит выдачу подписки, продление и идемпотентность в одном
 * месте, чтобы успешное списание всегда приводило к одному и тому же
 * результату.
 *
