 ...
 * инструментов не должна получать запрос, требующий записи в NocoDB или
 * изменения памяти, — поэтому несовместимый провайдер выпадает из цепочки
 * с явной причиной, а не молча.
 */
