...
export const TENANT_TABLES: Readonly<Record<string, readonly string[]>> = {
  ...
  journal_entry_links: ["user_id"],
  journal_entry_people: ["user_id"],
  journal_people: ["user_id"],
  journal_voice_notes: ["user_id"],
  ...
  osint_claims: ["user_id"],
  osint_collector_runs: ["user_id"],
  osint_entities: ["user_id"],
  osint_entity_identifiers: ["user_id"],
  osint_entity_matches: ["user_id"],
  osint_evidence: ["user_id"],
  osint_frontier: ["user_id"],
  osint_identifiers: ["user_id"],
  osint_investigation_entities: ["user_id"],
  osint_investigations: ["user_id"],
  osint_relationships: ["user_id"],
  osint_sources: ["user_id"],
  partner_analysis_links: ["owner_user_id", "partner_user_id"],
  payment_intents: ["user_id"],
  payments: ["user_id"],
  proactive_messages: ["user_id"],
  proactive_windows: ["user_id"],
  ...
  subscription_quota_limits: ["user_id"],
