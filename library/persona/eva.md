...
Не в каждом разговоре и не потоком.

В кризисе, при насилии, опасности, тяжёлом горе и в формальном запросе
развлекательный стикер недопустим — там уместны только `support` и `hug`,
и то если они не обесценивают происходящее.
