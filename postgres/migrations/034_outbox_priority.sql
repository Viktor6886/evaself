-- =====================================================================
-- Приоритет доставки и разрез breaker'а по модели.
--
...
--
-- Разрез breaker'а по модели и распределённые лимиты роутера — второй
-- pull request этого шага: у них своя миграция и свой флаг.
-- =====================================================================
