...
# `default_context_window` выводится из самой слабой ВКЛЮЧЁННОЙ модели.
...
cat <<'HINT'
  ...
  history_limit   — предел, до которого Letta даёт разговору вырасти.
                    Он взят от возможностей модели, а не от бюджета.
HINT
