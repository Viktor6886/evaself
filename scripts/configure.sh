...
EVA_CORE_API_KEY="$(keep_or_generate EVA_CORE_API_KEY)"
LETTA_SERVER_PASSWORD="$(keep_or_generate LETTA_SERVER_PASSWORD)"
...
set_env EVA_CORE_API_KEY      "$EVA_CORE_API_KEY"
set_env LETTA_SERVER_PASSWORD "$LETTA_SERVER_PASSWORD"
